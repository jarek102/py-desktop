...
├── versions.py          # Handles `gi.require_version` calls. Import it before `gi.repository`. Used to geneate type stubs.
...
│   │   └── Bar.py       # Python logic for the Bar window.
